<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <!--表格渲染-->
      <el-table-column align="center" style=" margin-bottom: 20px">教师发表的科研论文情况（自然年）</el-table-column>
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '论文', url: 'api/paper', sort: 'id,desc', crudMethod: { ...crudPaper }})
...
export default {
  ...
  methods: {
    openwj() {
      this.$router.push({ path: '/storage/index' })
    },
    // 获取数据前设置好接口地址
